<?php
    ...
    $stmt = $con->prepare("SELECT * FROM user 
        ...
        ON habilidades.id_cliente = user.id_cliente
        LEFT JOIN curriculo
        ON curriculo.id_cliente = user.id_cliente
        WHERE user.id_cliente = $id");
    $stmt->execute();
...
<body data-bs-theme="light">
    ...
    <aside id='header'>
        <section class="profile">
                <img src="../pictures/<?php echo $user2['foto']?>" alt=capa>
                <h1><?php echo $user2['nome']?></h1>
            ...
            <nav id="navbar" class="nav-menu">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="../chat/chat.php?id=<?php echo $id?>"> <i class="bi bi-chat-dots"></i>Chat ENDER
    ...
    <main id="main">
        ...
        <section id="inicio" class="row m-0 p-0">
            <div class="col-md-13 d-flex justify-content-center align-items-center flex-column">
                <h2 class=text-white text-shadow><?php echo $user2['nome']?> <?php echo $user2['sobrenome']?></h2>
            </div>
        ...
        <section class="container mt-5" id='sobre'>
            ...
            <div class="row mt-4">
                <div class="col-md-4">
                    <img class="img-fluid shadow" src="../pictures/<?php echo $user2['foto']?>" alt="foto" data-anime="left">
                </div>
                <div class="col-md-8" data-anime="right">

                    <h3><?php echo $user2['tipo_user']?></h3>
                    <p><?php echo $user2['bio']?></p>

                        <div class="row mt-3 mb-3">
                            <div class="col-md-6">
                                <ul class="list-group list-group-flush fs-5">
                                    <li class=list-group-item>
                                    Aniversário: <span class=fw-lighter><?php echo $user2['datanasc']?></span>
                                    </li>

                                    <li class=list-group-item>
                                    Cidade: <span class=fw-lighter><?php echo $user2['cidade']?></span>
                                    </li>

                                    <li class=list-group-item>
                                    Estado: <span class=fw-lighter><?php echo $user2['estado']?></span>
                                    </li>
                                </ul>
                            </div>
                            <?php
                            if($user2['tipo_user'] == "programador"){
                            ?>
                                <div class="col-md-6">
                                <ul class="list-group list-group-flush fs-5">
                                    <li class="list-group-item">
                                        Características: <span class="fw-lighter"><?php echo $user2['caracteristicas']?></span>
                                    </li>
                                    <li class="list-group-item">
                ...
                <div class="container pb-5">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <?php
                            $linguagem = array_filter([$user2['linguagem1'],$user2['linguagem2'],
                            $user2['linguagem3'],$user2['linguagem4'],$user2['linguagem5']]);
                            ...
                            ?>
                            <article class="card">
                                <h2><?php echo $user2['linguagem'.$i]?></h2>
                            </article>
                            <br>
                            <?php
                            $i++;
            ...
            <div class="container pb-5">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        $stmt->bind_param("si", $educ ,$user2_id);
                        $stmt->execute();
                    ...
                    <div class="col-md-6">
                        ...
                        $prof = "profissional";
                        $stmt = $con->prepare("SELECT * FROM curriculo WHERE tipo_cur = ? AND id_cliente = ?");
                        $stmt->bind_param("si", $prof, $user2_id);
                        $stmt->execute();
                        $curriculo = $stmt->get_result();
                        $existe = $curriculo->num_rows;
                        if($existe<1){
...
<!-- 
    ...
    <script>
        document.title = 'Perfil de <?php echo $user2['nome'];?>';
    </script>
