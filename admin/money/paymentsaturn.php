...
<head>
    ...
    <link rel="stylesheet" href="../css/paymentsaturn.css">
...
<form action="./acts/saturn.act.php" method="post">
<input type="hidden" name="plano" value="Saturno">
<input type="hidden" name="pagamento" value="29,99">
<input type="hidden" name="status" value="Realizado">
    ...
    <div class="row">
            <div class="col">
                ...
                <div class="inputBox">
                    <span>CEP:</span>
                    <input type="text" placeholder="01001-000" name="cep" id="cep">
                </div>

                <div class="inputBox">
                    <span>Cidade:</span>
                    <input type="text" placeholder="São Paulo" name="cidade" id="cidade" >
                </div>
                <div class="flex">
                <div class="inputBox">
                    <span>Estado:</span>
                    <input type="text" placeholder="São Paulo" name="estado" id="estado">
                </div>
