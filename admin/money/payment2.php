...
<form action="./acts/payment.act.php" method="post" id="address-form">
<input type="hidden" name="plano" value="Earth">
<input type="hidden" name="pagamento" value="19,99">
<input type="hidden" name="status" value="Realizado">
    ...
    <div class="row">
            <div class="col">
                ...
                <div class="inputBox">
                    <span>Cidade:</span>
                    <input type="text" placeholder="São Paulo" name="cidade" id="cidade" required
                    data-input disable>
                </div>
                <div class="flex">
                <div class="inputBox">
                    <span>Estado:</span>
                    <input type="text" placeholder="São Paulo" name="estado" id="estado" required
                    data-input disable>
                </div>
                </div>
