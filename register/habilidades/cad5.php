	...
	<section>
		<div class="form-box">
			<div class="form-value">
				<div class="logo">
				<a href="../../"> <img src="../../assets/img/logo.png" alt="Ender Softwares"> </a>
				</div>
				<form action="php/cad5.act.php" id="address-form" method="POST">
					<h2>Informações Pessoais</h2>
					
					<input type="radio" name="tipo_cur" value="Profissional" id="tipo1">
					<label for="tipo1">Profissional</label>
					<input type="radio" name="tipo_cur" value="Educacional" id="tipo2">
					<label for="tipo2">Educacional</label>
