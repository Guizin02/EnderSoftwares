	...
	<section>
		<div class="form-box">
			<div class="form-value">
				...
				<form action="php/cad4.act.php" id="address-form" method="POST">
					...
					<div class="inputbox">
                    <input id="carac" type="text" name="carac" required>
					...
					<div class="forget">
						<label for=""><a href="cad2.php"> Quero preencher essas informações depois</a></label>
					</div>
