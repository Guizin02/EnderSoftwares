				...
				<div class="card">
					<div class="card-header msg_head">
						<div class="d-flex bd-highlight">
							<div class="img_cont">
								<img id="fotoperfil" src="../pictures/<?php echo $user['foto']?>" class="rounded-circle user_img">
								<span class="online_icon"></span>
							</div>
							<div class="user_info">
								<a href="../public/perfil.php"><span id="nomeperfil"><strong><?php echo $user['nome']?></strong></span></a> 
							</div>
