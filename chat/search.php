<?php
    ...
    if ($_GET["term"]){
        ...
        // Query
        $stmt = $con->prepare("SELECT id_cliente, nome, foto, online FROM user WHERE (nome LIKE '%$nome%') ORDER BY nome DESC LIMIT 20");
        $stmt->execute();
            ...
            <li class="active" id="conversa">
				<div class="d-flex bd-highlight">
					<div class="img_cont">
						...
						<img id="pica" src="../pictures/<?php echo $other_user['foto']?>" class="rounded-circle user_img">
						<span class="online_icon"></span>
					</div>
                    <input type="hidden" name="" value="<?php echo $other_user['id_cliente']?>" id="inputt">
					<div class="user_info">
...
procurar.addEventListener('click', function(e) {
    ...
    $("#pesquisar").val("")
    imgperfil.setAttribute('src', '../pictures/'+foto)
