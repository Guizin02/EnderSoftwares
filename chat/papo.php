<?php
    ...
    if($_GET['id']){
        ...
        $stmt = $con->prepare("SELECT * FROM user WHERE id_cliente = ?");
        ...
        ?>
            <div class="d-flex justify-content-end mb-4">
				...
				<div class="img_cont_msg">
					<img src="../pictures/<?php echo $eu['foto']?>" class="rounded-circle user_img_msg">
				</div>
			</div>
        ...
        <?php
            ...
            <div class="d-flex justify-content-start mb-4">
				<div class="img_cont_msg">
					<img src="../pictures/<?php echo $outro['foto']?>" class="rounded-circle user_img_msg">
				</div>
